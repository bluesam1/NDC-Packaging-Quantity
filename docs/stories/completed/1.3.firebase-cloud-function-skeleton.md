...
- [x] Test deployment and invocation (AC: 8)
  - [x] Deploy function to Firebase (dev project)
  - [x] Test health endpoint via HTTP request
  - [x] Test compute endpoint with placeholder request
  - [x] Verify CORS headers are present
  - [x] Verify error responses work correctly
